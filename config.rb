...
#AppConfig[:db_url] = "jdbc:mysql://localhost:3306/Prod?user=admin&password=admin&useUnicode=true&characterEncoding=UTF-8"
##
...
AppConfig[:frontend_log_level] = "fatal"
...
AppConfig[:pui_log_level] = "fatal"
#
#AppConfig[:indexer_log] = "default"
AppConfig[:indexer_log_level] = "fatal"
#
#
...
#AppConfig[:pui_hide][:resource_badge] = true
