...
occs_db_secret_name = %x[aws ssm get-parameter --name /platform/archivesspace/3-5-0/pDBSecretName |jq --raw-output .Parameter.Value].strip!
occs_db_dbname = %x[aws ssm get-parameter --name /platform/archivesspace/3-5-0/pDBName |jq --raw-output .Parameter.Value].strip!
domain_name = %x[aws ssm get-parameter --name /platform/archivesspace/3-5-0/pDomainName |jq --raw-output .Parameter.Value].strip!
